...
{
    /// <summary>
    /// Represents a 4-column row object.
    /// </summary>
    ...
    public sealed class Row<T1, T2, T3, T4> : IEquatable<Row<T1, T2, T3, T4>>, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a default 4-column row.
        /// </summary>
        public Row()
        { }

        /// <summary>
        /// Initializes a new 4-column row.
        /// </summary>
        ...
        public Row(T1 column1, T2 column2, T3 column3, T4 column4)
        {
            _column1 = column1;
            _column2 = column2;
            _column3 = column3;
        ...
        public bool Equals(Row<T1, T2, T3, T4> other)
        {
            if (other == null)
            {
                return false;
        ...
        /// </summary>
        public Row<T1, T2, T3, T4> Clone()
        {
            return new Row<T1, T2, T3, T4>(_column1, _column2, _column3, _column4);
        }
        ...
        /// </summary>
        public Row<T1, T2, T3, T4> New()
        {
            return new Row<T1, T2, T3, T4>();
        }
        ...
        /// <summary>
        /// Creates a generic ICollection instance and adds this row and a new 4-column row.
        /// </summary>
        /// <param name="column1">The value of the column1.</param>
        /// <param name="column2">The value of the column2.</param>
        /// <param name="column3">The value of the column3.</param>
        /// <param name="column4">The value of the column4.</param>
        public ICollection<Row<T1, T2, T3, T4>> AddRow(T1 column1, T2 column2, T3 column3, T4 column4)
        {
            return new List<Row<T1, T2, T3, T4>>(new Row<T1, T2, T3, T4>[] { this, 
                new Row<T1, T2, T3, T4>(column1, column2, column3, column4) });
        }
