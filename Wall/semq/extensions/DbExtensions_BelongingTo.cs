...
namespace QueryTalk
{
    public static partial class Extensions
    {
        ...
        public static T BelongingTo<T>(this T node, ISemantic sentence)
            where T : ISemantic
        {
        ...
        public static T BelongingTo<T>(this T node, Expression expression)
            where T : ISemantic
        {
        ...
        /// <param name="sentence">A predicate sentence.</param>
        public static T BelongingTo<T>(this T node, Quantifier quantifier, ISemantic sentence)
            where T : ISemantic
        {
        ...
        /// <param name="quantifier">A quantifier of a predicate.</param>
        /// <param name="expression">A predicate expression.</param>
        public static T BelongingTo<T>(this T node, Quantifier quantifier, Expression expression)
            where T : ISemantic
        {
