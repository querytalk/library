...
namespace QueryTalk
{
    public static partial class Extensions
    {
        ...
        public static T RelatedTo<T>(this T node, ISemantic sentence)
            where T : ISemantic
        {
            return AddPredicate(node, sentence, true);
        }
        ...
        public static T RelatedTo<T>(this T node, Expression expression)
            where T : ISemantic
        {
            return AddPredicate(node, expression, true);
        }
        ...
        public static T RelatedTo<T>(this T node, ScalarArgument argument1, ValueScalarArgument argument2)
            where T : ISemantic
        {
        ...
        /// <param name="sentence">A predicate sentence.</param>
        public static T RelatedTo<T>(this T node, Quantifier quantifier, ISemantic sentence)
            where T : ISemantic
        {
            return AddPredicate(node, sentence, true, quantifier);
        }
        ...
        /// <param name="quantifier">A quantifier of a predicate.</param>
        /// <param name="expression">A predicate expression.</param>
        public static T RelatedTo<T>(this T node, Quantifier quantifier, Expression expression)
            where T : ISemantic
        {
            return AddPredicate(node, expression, true, quantifier);
        }
        ...
        /// <param name="argument1">The first argument in the equality expression.</param>
        /// <param name="argument2">The second argument in the equality expression.</param>
        public static T RelatedTo<T>(this T node, Quantifier quantifier, ScalarArgument argument1, ValueScalarArgument argument2)
            where T : ISemantic
        {
