...
namespace QueryTalk
{
    public static partial class Extensions
    {
        ...
        public static T Whose<T>(this T node, ISemantic sentence)
            where T : ISemantic
        {
        ...
        public static T Whose<T>(this T node, Expression expression)
            where T : ISemantic
        {
        ...
        public static T Whose<T>(this T node, ScalarArgument argument1, ValueScalarArgument argument2)
            where T : ISemantic
        {
        ...
        /// <param name="sentence">A predicate sentence.</param>
        public static T Whose<T>(this T node, Quantifier quantifier, ISemantic sentence)
            where T : ISemantic
        {
        ...
        /// <param name="quantifier">A quantifier of a predicate.</param>
        /// <param name="expression">A predicate expression.</param>
        public static T Whose<T>(this T node, Quantifier quantifier, Expression expression)
            where T : ISemantic
        {
        ...
        /// <param name="argument1">The first argument in the equality expression.</param>
        /// <param name="argument2">The second argument in the equality expression.</param>
        public static T Whose<T>(this T node, Quantifier quantifier, ScalarArgument argument1, ValueScalarArgument argument2)
            where T : ISemantic
        {
